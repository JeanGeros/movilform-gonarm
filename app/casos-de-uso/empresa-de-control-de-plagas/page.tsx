    ...
    <main className="w-full bg-white min-h-screen flex flex-col">
      ...
      <div className="px-4 md:px-0 pb-16 flex flex-col gap-6 max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
            <div className="flex gap-4 items-center">
              ...
              <div>
                ...
                <p className="font-satoshi text-[16px] text-[#231d1b] mt-3 leading-[24px] md:leading-[26px] text-justify">
        ...
        <div>
          ...
          <BenefitsCarousel
            benefits={[
              { img: IMG_EFICIENCIA, alt: "Eficiencia en control de plagas", title: "Eficiencia", desc: "Planifica tus servicios y optimiza los recursos y aumenta el control de las tareas que se ejecutan diariamente." },
              { img: IMG_ACCESIBILIDAD, alt: "Accesibilidad en el control de plagas", title: "Accesibilidad", desc: "Desde tu Smartphone o Tablet, captura toda la información que necesites y envía reportes automáticos." },
