...
const IMG_EFICIENCIA =
  "/casos-de-uso/empresa-de-servicio-de-higiene/eficiencia.webp";
const IMG_ACCESIBILIDAD =
  "/casos-de-uso/empresa-de-servicio-de-higiene/accesibilidad.webp";
const IMG_PRODUCTIVIDAD =
  "/casos-de-uso/empresa-de-servicio-de-higiene/productividad.webp";
      ...
      <div className="px-4 md:px-0 pb-16 flex flex-col gap-6 max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
            <div className="flex gap-4 items-center">
              ...
              <div className="font-satoshi text-[16px] text-justify text-[#231d1b] leading-[24px] md:leading-[26px] space-y-4">
                <p>
                  Las empresas que prestan servicios de Higiene son las
                  encargadas de mejorar la calidad de vida de las personas,
                  ayudando a reducir la propagación de enfermedades y
                  protegerlas de la contaminación.
                </p>
                <p>
                  Si tu empresa presta servicios de higiene ambiental o
                  industrial y tus tareas diarias están asociadas a realizar
                  instalación y mantenimiento de aromatizadores, dispensadores,
                  insumos y contenedores o realizas
                </p>
              </div>
            </div>
            <div className="flex gap-4 items-center">
              ...
              <div className="font-satoshi text-[16px] text-justify text-[#231d1b] leading-[24px] md:leading-[26px] space-y-4">
                <p>
                  Servicio de aromatización, higiene de superficies o de aire,
                  con MovilForm podrás programar y asignar las tareas necesarias
                  para cumplir con los requerimientos de tus clientes.
                </p>
                <p>
                  También podrás tener acceso a reportes y seguimiento online de
                  todas las actividades programadas y realizadas en terreno con
                  MovilForm.
                </p>
              </div>
            </div>
        ...
        <section className="bg-[#feeaed] rounded-[20px] px-6 py-10 md:px-[70px] md:py-[60px] my-4 md:my-10 text-center">
          ...
          <p className="font-satoshi mt-4 md:mt-6 text-[15px] md:text-[16px] text-[#232321] leading-[24px] md:leading-[26px] max-w-[500px] mx-auto">
            Con nuestro módulo de tareas, podrás planificar, asignar recursos y
            recibir reportes en línea de los trabajos realizados y visualizarlo
            en una plataforma web intuitiva y fácil de utilizar.
          </p>
        </section>
