...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const t = await getTranslations({ locale, namespace: "servicio-tecnico" });
  return {
    title: t("metaTitle"),
    description: t("metaDesc"),
    alternates: buildAlternates(locale, "/casos-de-uso/empresa-de-servicio-tecnico"),
  };
}

export default async function EmpresaDeServicioTecnico({
  params,
}: {
  ...
  const t = await getTranslations("servicio-tecnico");
