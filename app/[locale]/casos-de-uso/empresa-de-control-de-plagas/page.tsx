...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const t = await getTranslations({ locale, namespace: "control-de-plagas" });
  return {
    title: t("metaTitle"),
    description: t("metaDesc"),
    alternates: buildAlternates(locale, "/casos-de-uso/empresa-de-control-de-plagas"),
  };
}

export default async function EmpresaDeControlDePlagas({
  params,
}: {
  ...
  const t = await getTranslations("control-de-plagas");
