...
const CASOS_DE_USO = [
  {
    label: "Mantenimientos Preventivos y Correctivos",
    href: "/casos-de-uso/mantenimientos-preventivos-y-correctivos",
  },
  {
    label: "Empresa de Gestión de Residuos",
    href: "/casos-de-uso/empresa-de-gestion-de-residuos",
  },
  {
    label: "Empresa de Telecomunicaciones",
    href: "/casos-de-uso/empresa-de-telecomunicaciones",
  },
  {
    label: "Empresa de Control de Plagas",
    href: "/casos-de-uso/empresa-de-control-de-plagas",
  },
  {
    label: "Empresa de Servicio de Higiene",
    href: "/casos-de-uso/empresa-de-servicio-de-higiene",
  },
  {
    label: "Empresa de Servicio Técnico",
...
export default function Footer({
  ...
  return (
    <footer className="mt-auto">
      {/* Card */}
      <div
        className={`max-w-7xl mx-auto ${cardBg} rounded-[20px] px-6 md:px-[40px] pt-10 md:pt-14 pb-5`}
      >
